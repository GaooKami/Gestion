...
entry_quantite = tk.Entry(cadre_ajout_produit)
...
entry_prix_achat = tk.Entry(cadre_ajout_produit)
...
entry_prix_vente = tk.Entry(cadre_ajout_produit)
...
entry_quantite_vendue = tk.Entry(cadre_vente_produit)
